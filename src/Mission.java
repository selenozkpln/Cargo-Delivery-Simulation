...
// Description: This class handles the logistics system's mission operations, including loading data
...
public class Mission {
    ...
    String readCities = "src/cities.txt";
    String readPackages = "src/packages.txt";
    String readVehicles = "src/vehicles.txt";
    String readMissions = "src/missions.txt";
    ...
    public Mission(String source, String middle, String destination, int loadFromSource, int loadFromMiddle, int[] dropOffIndices)
    //--------------------------------------------------------
    // Summary: Constructs a new Mission object with specified parameters.
    ...
    //--------------------------------------------------------
    // Summary: Loads city, package, and vehicle data from respective files.
    ...
    //--------------------------------------------------------
    // Summary: Loads city data from cities file and adds each city to the city list.
    ...
    //--------------------------------------------------------
    // Summary: Loads package data from packages file and assigns packages to the appropriate city.
    ...
    //--------------------------------------------------------
    // Summary: Loads vehicle data from vehicles file and assigns vehicles to the appropriate city.
    ...
    public void readMission() throws IOException
    //--------------------------------------------------------
    // Summary: Reads mission data from missions file and executes each mission based on the details provided.
